...
window.f1 = function() {
   ...
   const urlArr = [
       {
           ...
           url:'http://10.70.16.168:37799/webroot/decision/view/form?viewlet=硅钢/161无取向精整机组可视化画面.frm&unit_code='
       },
       {
           unit_code: ['Q173','Q174','Q175'],
           url:'http://10.70.16.168:37799/webroot/decision/view/form?viewlet=硅钢/171取向精整机组可视化画面.frm&unit_code='
       },
       {
           unit_code: ['Q314'],
   ...
   function product(obj) {
       ...
       code.css({'cursor':'pointer'}).click(function(){
           ...
           num.attr({
               'fill':'#03FFFF'
           }).filter('[data-index='+dataIndex+']').attr({
               'fill':'#F29600'
           })
   ...
   function equipment(obj) {
       ...
       $('#stoptime tspan:eq(0)').text(stopTime);
       $('#stoptotal tspan:eq(0)').text(stopTotal);
   }
